...
\documentclass[unicode,11pt]{beamer}% 'unicode'が必要
...
\onslide*<1>{\includegraphics[clip]{./fig/Mullins_Efct.pdf}}
\onslide*<2>{\includegraphics[clip]{./fig/Hysteresis_10mm.pdf}}
\transboxout[duration=1]<2>
...
\onslide*<1>{\includegraphics[clip]{./fig/Mullins_Efct.pdf}}
\onslide*<2>{\includegraphics[clip]{./fig/Hysteresis_10mm.pdf}}
\transsplitverticalin[duration=1]<2>
...
\onslide*<1>{\includegraphics[clip]{./fig/Mullins_Efct.pdf}}
\onslide*<2>{\includegraphics[clip]{./fig/Hysteresis_10mm.pdf}}
\transsplitverticalout[duration=1]<2>
