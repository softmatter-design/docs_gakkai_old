...
\begin{minipage}{0.33\hsize}
	\begin{center}
	\includegraphics[width=50mm]{./fig/PR_BW.pdf}
	\caption{End to end distance of strands for 3-Chain model(N20)}
	\label{fig:e2e}
	\end{center}
\end{minipage}
\begin{minipage}{0.33\hsize}
	\begin{center}
	\includegraphics[width=50mm]{./fig/SS_all_BW.pdf}
	\caption{SS Curves for 3-Chain model(N20) with varied cells}
	\label{fig:SS_cells}
	\end{center}
\end{minipage}
\begin{minipage}{0.33\hsize}
